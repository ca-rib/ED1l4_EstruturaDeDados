...
namespace Atividade-21-08-2023
{
    internal class Program    {
        ...
        static void Main(string[] args)
        {
            ...
            Contato carol = new Contato("carol", "carol", new Data(31, 8, 2001));

            carol.adicionarTelefone(new Telefone("Celular", "9999999", true));
            carol.adicionarTelefone(new Telefone("Residencial", "88888888", false));

            contatos.adicionar(carol);
